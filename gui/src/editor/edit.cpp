 ...
 */
{
    ...
    case musicKeyTypeMusicalSharps:
        ui.displayMusicKey->setCurrentIndex(0);
        break;
    case musicKeyTypeMusicalFlats:
        ui.displayMusicKey->setCurrentIndex(1);
        break;
    case musicKeyTypeOpenKey:
        ui.displayMusicKey->setCurrentIndex(2);
        break;
    case musicKeyTypeCustom:
        ui.displayMusicKey->setCurrentIndex(3);
        break;
    default:
        ui.displayMusicKey->setCurrentIndex(1);
        break;
 ...
 */
{
    ...
    setTracklistCaptions();
    connect(trackList, SIGNAL(customContextMenuRequested(const QPoint&)), this,
            SLOT(on_trackList_customContextMenuRequested(const QPoint&)));
    connect(trackList, SIGNAL(itemDoubleClicked(QTreeWidgetItem*, int)), this, SLOT(on_trackList_itemDoubleClicked(QTreeWidgetItem*, int)));
    connect(trackList, SIGNAL(itemClicked(QTreeWidgetItem*, int)), this, SLOT(on_trackList_itemClicked(QTreeWidgetItem*, int)));
    ...
    if (type == QEvent::KeyPress) {
        ...
        if (type == QEvent::FocusIn) {
            ...
            if (position > 7 && DupeCheck == false) {
                CheckDupes();
            } else if (position < 8 && DupeCheck == true)
                DupeCheck = false;
...
void Edit::on_DupeTimer_update()
{
    ...
    count++;
    if (count & 1)
        DupeCheckIcon = ":/fkeys/resources/fkeys/f-key-3005.png";
    else
        DupeCheckIcon = ":/fkeys/resources/fkeys/f-key-2005.png";
    if (position > 7) {
...
void Edit::UpdateFkeys()
{
    ...
    // Suchbutton
    if (position == 4 || position == 5 || position == 6 || position == 8 || position == 15 || position == 17 || position == 19) {
 ...
 */
{
    ...
    case 14:
        ...
        break;
    case 15:
        ui.labelName->setFocus();
        break;
    case 16:
        ui.recordSourceId->setFocus();
        break;
    case 17:
        ui.recordSource->setFocus();
        break;
    case 18:
        ui.recordDeviceId->setFocus();
        break;
    case 19:
        ui.recordDevice->setFocus();
        break;
    case 20:
        ui.remarks->setFocus();
        break;
    ...
    case 22:
        ...
        break;
    case 23:
        ui.realTitle->setFocus();
        break;
    case 24:
        ui.interrupted->setFocus();
        break;
    case 25:
...
QWidget* Edit::GetWidgetFromPosition(int position)
{
    ...
    case 11:
        return ui.bpm;
    case 12:
        return ui.releaseDate;
    case 13:
        return ui.recordDate;
    case 14:
        return ui.album;
    case 15:
        return ui.labelId;
    case 16:
        return ui.labelName;
    case 17:
        return ui.recordSourceId;
    case 18:
        return ui.recordSource;
    case 19:
        return ui.recordDeviceId;
    case 20:
        return ui.recordDevice;
    case 21:
        return ui.remarks;
    case 22:
        return ui.tags;
...
void Edit::handleFileDropEvent(QDropEvent* event)
{
    ...
    if (ExistingFile.notEmpty()) {
        if (QMessageBox::question(this, tr("WinMusik: overwrite existing file"), tr("Do you want to overwrite the exiting file?"),
 ...
 */
{
    ...
    if (key == Qt::Key_Escape) {
        ...
        if (modifier == Qt::NoModifier)
            trackList->verticalScrollBar()->triggerAction(QAbstractSlider::SliderPageStepAdd);
        else if (modifier == Qt::ShiftModifier)
            trackList->verticalScrollBar()->triggerAction(QAbstractSlider::SliderSingleStepAdd);
        return true;
        // *************************************************************************** Page up
    } else if (position > 2 && key == Qt::Key_PageUp) {
        if (modifier == Qt::NoModifier)
            trackList->verticalScrollBar()->triggerAction(QAbstractSlider::SliderPageStepSub);
        else if (modifier == Qt::ShiftModifier)
            trackList->verticalScrollBar()->triggerAction(QAbstractSlider::SliderSingleStepSub);
        return true;
        // *************************************************************************** F2
        ...
        return true;
        // *************************************************************************** F6
    } else if (key == Qt::Key_F6 && modifier == Qt::ControlModifier && ui.fkeys->isEnabled(6) == true && position > 3 &&
               wm->conf.DevicePath[DeviceType].notEmpty() == true) {
...
bool Edit::on_artist_FocusIn()
{
    ...
    QTreeWidgetItem* w;
    int i = TrackNum;
    while (NULL == (w = trackList->topLevelItem(i - 1)) && i > 0)
        i--;
    if (w) {
...
bool Edit::on_f7_DeleteTrack()
{
    if (Track.Track > 0) {
        if (Track.TitleId) {
            ...
            if (Ti != NULL && Ti->DeviceType == DeviceType && Ti->DeviceId == DeviceId && Ti->Page == Page) {
...
bool Edit::on_f10_WritePlaylist()
{
    if (wm->WritePlaylist(DeviceType, DeviceId, Page, &TrackList, &datadevice)) {
        QMessageBox::information(this, tr("WinMusik: Notice"), tr("Playlists wurden erfolgreich erstellt"));
        return true;
    }
...
void Edit::on_esc_clicked()
{
    if (position < 2) {
        ...
        ui.index->setFocus();
    else if (position == 3 && datadevice.Pages == 1)
        ui.index->setFocus();
    else if (position == 3 && datadevice.Pages > 1)
        ui.page->setFocus();
    else if (position == 4)
...
void Edit::on_f3_clicked()
{
    if (position == 3) {
        renumber();
    } else if (position == 4 || position == 5 || position == 7 || position == 9 || position == 14 || position == 16 || position == 18 ||
...
void Edit::on_f5_clicked()
{
    ...
    if (position == 4)
        on_f5_ShortCut(Qt::NoModifier);
    else if (position > 7)
        on_f5_CheckDupes(NULL);
}
void Edit::on_f6_clicked()
{
    if (position == 3)
        ...
        on_f6_Pressed(GetWidgetFromPosition(position), Qt::NoModifier);
}
...
{
    if (QMessageBox::question(this, tr("WinMusik: update all ID3-Tags"), tr("Update ID3-Tags of all tracks?"),
                              QMessageBox::Yes | QMessageBox::No, QMessageBox::No) == QMessageBox::No)
        return true;

    if (wm->UpdateID3Tags(DeviceType, DeviceId, Page, &TrackList)) {
        QMessageBox::information(this, tr("WinMusik: Notice"), tr("Update of ID3-Tags on all tracks has been started"));
        return true;
    }
    ...
    if (t) {
        ...
        if (key & (Qt::AltModifier | Qt::MetaModifier)) {
            ...
            Text.setf("%s - %s (%s, %0i:%02i min, %s)", (const char*)t->Artist, (const char*)t->Title,
                      (const char*)wm->GetVersionText(t->VersionId), t->Length / 60, t->Length % 60,
                      (const char*)wm->GetGenreText(t->GenreId));
            Text.appendf(" [%s %u %c-%i]", (const char*)wm->GetDeviceNameShort(t->DeviceType), t->DeviceId, (t->Page + 'A' - 1), t->Track);
        }
        ...
        if (column == TRACKLIST_RATING_ROW) {
            ...
            if (r != t->Rating) {
                ...
                if (wm_main->conf.bWriteID3Tags == true) {
                    ppl7::String Path = wm->GetAudioFilename(tUpdate.DeviceType, tUpdate.DeviceId, tUpdate.Page, tUpdate.Track);
                    if (Path.notEmpty()) {
                        if (!wm->SaveID3Tags(tUpdate.DeviceType, tUpdate.DeviceId, tUpdate.Page, tUpdate.Track, tUpdate)) {
                ...
                switch (r) {
                case 0:
                    item->setIcon(TRACKLIST_RATING_ROW, QIcon(":/bewertung/resources/sterne64x16-0.png"));
                    item->setText(TRACKLIST_RATING_ROW, "0");
                    break;
                case 1:
                    item->setIcon(TRACKLIST_RATING_ROW, QIcon(":/bewertung/resources/sterne64x16-1.png"));
                    item->setText(TRACKLIST_RATING_ROW, "1");
                    break;
                case 2:
                    item->setIcon(TRACKLIST_RATING_ROW, QIcon(":/bewertung/resources/sterne64x16-2.png"));
                    item->setText(TRACKLIST_RATING_ROW, "2");
                    break;
                case 3:
                    item->setIcon(TRACKLIST_RATING_ROW, QIcon(":/bewertung/resources/sterne64x16-3.png"));
                    item->setText(TRACKLIST_RATING_ROW, "3");
                    break;
                case 4:
                    item->setIcon(TRACKLIST_RATING_ROW, QIcon(":/bewertung/resources/sterne64x16-4.png"));
                    item->setText(TRACKLIST_RATING_ROW, "4");
                    break;
                case 5:
                    item->setIcon(TRACKLIST_RATING_ROW, QIcon(":/bewertung/resources/sterne64x16-5.png"));
                    item->setText(TRACKLIST_RATING_ROW, "5");
                    break;
                case 6:
                    item->setIcon(TRACKLIST_RATING_ROW, QIcon(":/bewertung/resources/sterne64x16-6.png"));
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (item) {
                    ...
                    if (title != NULL && title->Key > 0) {
                        if (title->Key == t->Key)
                            item->setBackground(TRACKLIST_KEY_ROW, colorscheme.sameKey);
                        else {
 ...
 */
{
    ...
    if (TrackList.Num() > 0 && (trackList->currentColumn() == TRACKLIST_KEY_ROW || trackList->currentColumn() == TRACKLIST_BPM_ROW ||
                                trackList->currentColumn() == TRACKLIST_ENERGYLEVEL_ROW)) {
        a = m->addAction(QIcon(":/icons/resources/sync-keys.png"),
                         tr("Synchronize Keys, BPM and Energy with ID3-Tag", "trackList Context Menue"), this,
                         SLOT(on_contextSynchronizeKeys_triggered()));
        ...
        if (t != NULL && (t->Flags & 16) == 0)
            m->addAction(QIcon(":/icons/resources/musicKeyOk.png"), tr("Music Key is verified", "trackList Context Menue"), this,
                         SLOT(on_contextMusicKeyVerified_triggered()));
        else if (t != NULL && (t->Flags & 16) == 16)
            m->addAction(QIcon(":/icons/resources/musicKeyNotOk.png"), tr("Music Key is not verified", "trackList Context Menue"), this,
                         SLOT(on_contextMusicKeyVerified_triggered()));
    } else {
        if (trackList->currentColumn() == TRACKLIST_COVER_ROW) {
            a = m->addAction(QIcon(":/icons/resources/view_cover.png"), tr("Show cover", "trackList Context Menue"), this,
                             SLOT(on_contextShowCover_triggered()));
            m->addAction(QIcon(":/icons/resources/load_cover.png"), tr("Load Cover for all Tracks", "trackList Context Menue"), this,
                         SLOT(on_contextLoadCoverAllTracks_triggered()));

        } else {
            a = m->addAction(QIcon(":/icons/resources/findmore.png"), tr("Find other versions", "trackList Context Menue"), this,
                             SLOT(on_contextFindMoreVersions_triggered()));
            m->addAction(QIcon(":/icons/resources/findmore-artist.png"), tr("Find more of artist", "trackList Context Menue"), this,
                         SLOT(on_contextFindMoreArtist_triggered()));
            m->addAction(QIcon(":/icons/resources/findmore-title.png"), tr("Find other artists of this title", "trackList Context Menue"),
                         this, SLOT(on_contextFindMoreTitle_triggered()));
        }
        m->addAction(QIcon(":/icons/resources/play.png"), tr("Play Track", "trackList Context Menue"), this,
                     SLOT(on_contextPlayTrack_triggered()));
        m->addAction(QIcon(":/icons/resources/edit.png"), tr("Edit Track", "trackList Context Menue"), this,
                     SLOT(on_contextEditTrack_triggered()));
        m->addAction(QIcon(":/icons/resources/copytrack.png"), tr("Copy Artist and Title", "trackList Context Menue"), this,
                     SLOT(on_contextCopyTrack_triggered()));
        m->addAction(QIcon(":/icons/resources/copyfile.png"), tr("Copy MP3-File", "trackList Context Menue"), this,
                     SLOT(on_contextCopyFile_triggered()));
        m->addAction(QIcon(":/icons/resources/copycover.png"), tr("Copy Cover", "trackList Context Menue"), this,
                     SLOT(on_contextCopyCover_triggered()));
        m->addSeparator();
        m->addAction(QIcon(":/icons/resources/delete-track.png"), tr("Delete Track", "trackList Context Menue"), this,
                     SLOT(on_contextDeleteTrack_triggered()));
        m->addAction(QIcon(":/icons/resources/insert-track.png"), tr("Insert Track", "trackList Context Menue"), this,
                     SLOT(on_contextInsertTrack_triggered()));
        if (TrackList.Num() > 0 && trackList->currentColumn() == TRACKLIST_BPM_ROW) {
            m->addSeparator();
            m->addAction(QIcon(":/icons/resources/edit.png"), tr("Read BPM and Key from ID3-Tag", "trackList Context Menue"), this,
                         SLOT(on_contextReadBpmAndKey_triggered()));
        }
        m->addAction(QIcon(":/icons/resources/eraser.png"), tr("Delete ID3-Tags from file", "trackList Context Menue"), this,
                     SLOT(on_contextDeleteID3Tags_triggered()));
    }
    m->popup(p, a);
    // FixFocus();
}
...
void Edit::on_displayMusicKey_currentIndexChanged(int)
{
    ...
    case 0:
        musicKeyDisplay = musicKeyTypeMusicalSharps;
        break;
    case 1:
        musicKeyDisplay = musicKeyTypeMusicalFlats;
        break;
    case 2:
        musicKeyDisplay = musicKeyTypeOpenKey;
        break;
    case 3:
        musicKeyDisplay = musicKeyTypeCustom;
        break;
    default:
        musicKeyDisplay = musicKeyTypeOpenKey;
        break;
...
void Edit::on_contextDeleteID3Tags_triggered()
{
    ...
    if (QMessageBox::question(this, tr("WinMusik: delete ID3-Tags"), tr("Do you want to delete all ID3-Tags from the selected files?"),
                              QMessageBox::Yes | QMessageBox::No, QMessageBox::No) == QMessageBox::No)
        return;
    for (int i = 0; i < Items.size(); i++) {
