...
void SearchlistDialog::renderTrack(SearchlistTreeItem* item)
{
    ...
    if (item->Track.Label.notEmpty()) {
        item->setText(SL_COLUMN_LABEL, item->Track.Label);
    } else if (item->Track.Comment.notEmpty()) {
    ...
    case 0:
        item->setIcon(SL_COLUMN_RATING, QIcon(":/bewertung/resources/rating-0.png"));
        item->setText(SL_COLUMN_RATING, "0");
        break;
    case 1:
        item->setIcon(SL_COLUMN_RATING, QIcon(":/bewertung/resources/rating-1.png"));
        item->setText(SL_COLUMN_RATING, "1");
        break;
    case 2:
        item->setIcon(SL_COLUMN_RATING, QIcon(":/bewertung/resources/rating-2.png"));
        item->setText(SL_COLUMN_RATING, "2");
        break;
    case 3:
        item->setIcon(SL_COLUMN_RATING, QIcon(":/bewertung/resources/rating-3.png"));
        item->setText(SL_COLUMN_RATING, "3");
        break;
    case 4:
        item->setIcon(SL_COLUMN_RATING, QIcon(":/bewertung/resources/rating-4.png"));
        item->setText(SL_COLUMN_RATING, "4");
        break;
    case 5:
        item->setIcon(SL_COLUMN_RATING, QIcon(":/bewertung/resources/rating-5.png"));
        item->setText(SL_COLUMN_RATING, "5");
        break;
    case 6:
        item->setIcon(SL_COLUMN_RATING, QIcon(":/bewertung/resources/rating-6.png"));
...
void SearchlistDialog::on_trackList_customContextMenuRequested(const QPoint& pos)
{
    ...
    if (column == SL_COLUMN_RATING) {
        ...
        a = m->addAction(QIcon(":/icons/resources/edit.png"), tr("Edit Track", "trackList Context Menue"), tr("Return"), this,
                         SLOT(on_contextEditTrack_triggered()));
        m->addAction(QIcon(":/icons/resources/delete-track.png"), tr("Delete Track", "trackList Context Menue"), tr("Del"), this,
                     SLOT(on_contextDeleteTrack_triggered()));
        m->addAction(QIcon(":/icons/resources/insert-track.png"), tr("Insert Track", "trackList Context Menue"), tr("Ctrl+N"), this,
                     SLOT(on_contextInsertTrack_triggered()));
        m->addSeparator();
        m->addAction(QIcon(":/icons/resources/findmore.png"), tr("Search track in Database", "trackList Context Menue"), tr("F4"), this,
                     SLOT(on_contextFind_triggered()));
    }
    m->popup(p, a);
}
