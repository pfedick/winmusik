...
void PlaylistEdit::filloutFields(PlaylistItem* item)
{
    ...
    if (Tag.frameCount() > 0) {
        ...
        // if (wmlog) wmlog->Printf(ppl6::LOG::DEBUG, 9, "WinMusik", "PlaylistEdit::filloutFields", __FILE__, __LINE__, "ID3-Tags not
        // loaded");
    }
    updateTotalTime();
}
...
void PlaylistEdit::loadTraktorCues(const ppl7::ID3Tag& Tag)
{
    ...
    for (it = cuelist.begin(); it != cuelist.end(); it++) {
        ...
        if (it->type == TraktorTagCue::GRID)
            item->setIcon(1, QIcon(":/icons/resources/cuegrid.png"));
        else if (it->type == TraktorTagCue::IN)
            item->setIcon(1, QIcon(":/icons/resources/cuein.png"));
        else if (it->type == TraktorTagCue::OUT)
            item->setIcon(1, QIcon(":/icons/resources/cueout.png"));
        else if (it->type == TraktorTagCue::LOAD)
            item->setIcon(1, QIcon(":/icons/resources/cueload.png"));
        else if (it->type == TraktorTagCue::LOOP)
            item->setIcon(1, QIcon(":/icons/resources/cueloop.png"));
        else
            item->setIcon(1, QIcon(":/icons/resources/cuepoint.png"));
    ...
    if (traktorIn >= 0 || traktorOut >= 0)
        ui.traktorUseInOutButton->setEnabled(true);
    else
        ui.traktorUseInOutButton->setEnabled(false);
}
...
void PlaylistEdit::cue2CutStart(int cut)
{
    ...
    switch (cut) {
    case 0:
        ui.cutStart0->setText(Tmp);
        break;
    case 1:
        ui.cutStart1->setText(Tmp);
        break;
    case 2:
        ui.cutStart2->setText(Tmp);
        break;
    case 3:
        ui.cutStart3->setText(Tmp);
        break;
    case 4:
        ui.cutStart4->setText(Tmp);
        break;
    }
    updateTotalTime();
}
...
void PlaylistEdit::cue2CutEnd(int cut)
{
    ...
    switch (cut) {
    case 0:
        ui.cutEnd0->setText(Tmp);
        break;
    case 1:
        ui.cutEnd1->setText(Tmp);
        break;
    case 2:
        ui.cutEnd2->setText(Tmp);
        break;
    case 3:
        ui.cutEnd3->setText(Tmp);
        break;
    case 4:
        ui.cutEnd4->setText(Tmp);
        break;
    }
    updateTotalTime();
}
...
void PlaylistEdit::cutDelete(int cut)
{
    switch (cut) {
    case 0:
        ui.cutStart0->setText("0:00.000");
        ui.cutEnd0->setText("0:00.000");
        break;
    case 1:
        ui.cutStart1->setText("0:00.000");
        ui.cutEnd1->setText("0:00.000");
        break;
    case 2:
        ui.cutStart2->setText("0:00.000");
        ui.cutEnd2->setText("0:00.000");
        break;
    case 3:
        ui.cutStart3->setText("0:00.000");
        ui.cutEnd3->setText("0:00.000");
        break;
    case 4:
        ui.cutStart4->setText("0:00.000");
