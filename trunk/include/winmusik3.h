 ...
 * $Id: winmusik3.h,v 1.1 2010/05/16 12:23:29 pafe Exp $
 *
 *
...
#define WM_RELEASEDATE	20091204
#define WM_COPYRIGHT	"(c) Copyright by Patrick Fedick in 2009"
...
class CTitleHashTree : public ppl6::CAVLTree
{
	public:
		...
		virtual int GetValue(const void *item, ppl6::CString &buffer)
		{
...
class CHashes : public ppl6::CThread
{
	...
	public:
		...
		int FindGlobal(const ppl6::CString &Query, CTitleHashTree &Result);
...
class CWmClient
{
	...
	public:
		...
		void OpenEditor(int devicetype);
