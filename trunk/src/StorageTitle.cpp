...
int DataTitle::keyId(const ppl6::CString &name)
{
	...
	if (k=="g#m" || k=="g#min" || k=="abm" || k=="1a") return 1;
	else if (k=="b" || k=="bmaj" || k=="1b") return 2;
	else if (k=="d#m" || k=="d#min" || k=="ebm" || k=="2a") return 3;
	else if (k=="f#" || k=="f#maj" || k=="gb" || k=="2b") return 4;
	else if (k=="a#m" || k=="a#min" || k=="bbm" || k=="3a") return 5;
	else if (k=="c#" || k=="c#maj" || k=="db" || k=="3b") return 6;
	else if (k=="fm" || k=="fmin" || k=="4a") return 7;
	else if (k=="g#" || k=="g#maj" || k=="ab" || k=="4b") return 8;
	else if (k=="cm"|| k=="cmin" || k=="5a") return 9;
	else if (k=="d#" || k=="d#maj" || k=="eb" || k=="5b") return 10;
	else if (k=="gm" || k=="gmin" || k=="6a") return 11;
	else if (k=="a#" || k=="a#maj" || k=="bb" || k=="6b") return 12;
	else if (k=="dm" || k=="dmin" || k=="7a") return 13;
	else if (k=="f" || k=="fmaj" || k=="7b") return 14;
	else if (k=="am" || k=="amin" || k=="8a") return 15;
	else if (k=="c" || k=="cmaj" || k=="8b") return 16;
	else if (k=="em" || k=="emin" || k=="9a") return 17;
	else if (k=="g" || k=="gmaj" || k=="2b") return 18;
	else if (k=="bm" || k=="bmin" || k=="10a") return 19;
	else if (k=="d" || k=="dmaj" || k=="10b") return 20;
	else if (k=="f#m" || k=="f#min" || k=="gbm" || k=="11a") return 21;
	else if (k=="a" || k=="amaj" || k=="11b") return 22;
	else if (k=="c#m" || k=="c#min" || k=="dbm" || k=="12a") return 23;
	else if (k=="e" || k=="emaj" || k=="12b") return 24;
	return 0;
}
